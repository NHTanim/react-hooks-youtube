...
const UseContextThree = () => {
    ...
    const Three = useContext(noteContext)
    return (
        <div className='mx-40'>
            <h1 className='font-bold'>OutPut</h1>
            <h1 className='font-semibold'>My Name is {Three.name}</h1>
            <h1 className='font-semibold'>University {Three.vrcty}</h1>
            <h1 className='font-semibold'>Id : {Three.id}</h1>
